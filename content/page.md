...
1. Lectura 1 
2. Lectura 2  
3. Lectura 3 <button onclick="window.open('https://github.com/migariane/CrashCourseCausalInference/tree/master/content/Lecturas/Lecture3.pdf')">Download</button>
